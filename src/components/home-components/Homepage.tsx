...
import HomepageSlider from "./homepage-components/HomepageSlider";
import HomepagePlatform from './homepage-components/HomepagePlatform';
import HomepageFooter from './homepage-components/HompageFooter';
